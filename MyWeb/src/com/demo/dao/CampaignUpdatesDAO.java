...
/**
 	* A data access object (DAO) providing persistence and search support for CampaignUpdates entities.
 ...
 */
public class CampaignUpdatesDAO extends BaseHibernateDAO  {
    ...
    public CampaignUpdates findById( java.lang.Integer id) {
        ...
        try {
            CampaignUpdates instance = (CampaignUpdates) getSession()
                    .get("com.xxxxxx.CampaignUpdates", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(CampaignUpdates instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.xxxxxx.CampaignUpdates")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding CampaignUpdates instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from CampaignUpdates as model where model." 
         						+ propertyName + "= ?";
    ...
    public CampaignUpdates merge(CampaignUpdates detachedInstance) {
        ...
        try {
            CampaignUpdates result = (CampaignUpdates) getSession()
